...
public class MD5Util {
     ...
     * 帐号密码MD5加密的盐
     */
    private static final String PWD_MD5_SALT = "com.chichao.eyyg.user.service.mall.CustomerServiceImpl.PWD_MD5_SALT";
     ...
     * @return 密文
     */
    public static String pwdEncoding(String pwd) {
        return DigestUtils.md5Hex(PWD_MD5_SALT + pwd);
    }
    ...
    public static String createMD5(String data) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        MessageDigest md = MessageDigest.getInstance("MD5");
