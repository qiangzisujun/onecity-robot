 ...
 */
@Table(name = "customer_employ_withdraw_record")
@Data
public class CustomerEmployWithdrawRecord implements Serializable {

    private static final long serialVersionUID = -7559263867722790917L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    private Integer state;		//'处理状态 0审核中  1审核通过  2审核不通过  3已提现 '
    private Integer withdrawType;//提现类型 1余额 2福分
    ...
    @Transient
    private Double scoreSum;//佣金总额
    @Transient
    private Double checkScoreSum;//正在审核的佣金总额
    @Transient
    private Double arScoreSum;//已提现的佣金总额
